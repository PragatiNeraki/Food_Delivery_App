...
const DeliveryDetails:FunctionComponent<{details:any}> = ({details}) => {
    return (
        <View style={styles.container}>
            ...
            <View style={styles.flexRow2}>
                ...
                <View style={{width:'80%'}}>
                    <CustomText variant='h8' fontFamily={Fonts.Medium}>{details?.name || '---'} {details?.phone || 'XXXXXXXXXX'}</CustomText>
