...
const withLiveStatus=<P extends object>(WrappedComponent:React.ComponentType<P>):FunctionComponent <P>=>{
    const WithLiveStatusComponent:FunctionComponent<P>= (props) => {
