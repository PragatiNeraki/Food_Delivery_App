    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.deliveryContainer}>
                <CustomText variant='h4' fontFamily={Fonts.SemiBold} style={styles.deliveryContainer}>
                    Delivering to Home
                </CustomText>
            </View>
            <CustomText variant='h8' style={styles.addressText} fontFamily={Fonts.SemiBold}>
