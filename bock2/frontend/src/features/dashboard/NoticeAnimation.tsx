...
const NoticeAnimation:FunctionComponent<{noticePosition:any; children:React.ReactElement}> 
    ...
    return (
        <View style={styles.container}>
            ...
            <RNAnimated.View style={[styles.contentContainer,{
                ...
                // paddingTop: noticePosition.interpolate({
                //     inputRange: [Math.round(NOTICE_HEIGHT), 0],
                //     outputRange: [0, Math.round(NOTICE_HEIGHT + 20)],
                // })
